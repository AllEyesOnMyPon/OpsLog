...
## 4. Wyślij sample logi z emitera CSV
...
W repo jest gotowy dashboard: `docs/grafana_dashboard.json`.

1. W Grafanie: **Dashboards → New → Import**  
2. Kliknij **Upload JSON file** i wskaż `docs/grafana_dashboard.json`  
3. Wybierz datasource **Loki** (jeśli wymagane) i kliknij **Import**  

Po imporcie pojawi się dashboard z widokiem logów i metryk dopasowany do LogOps.
